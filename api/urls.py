...
from api.views.comment import CommentCreateView, CommentListView, RetrieveCommentView
...
urlpatterns = [
    ...
    path("comment/photo/<int:id>/", CommentCreateView.as_view()),
    path("comment/photo/<int:id>/list/", CommentListView.as_view()),
